...
if (process.platform === 'win32') {
    try { require('child_process').execSync('chcp 65001', { stdio: 'ignore' }); } catch { /* 忽略 */ }
...
const renderer_dirpath = path.join(__dirname, "..", "renderer")

let MainWindow = null

function createWindow() {
    configManager.init()
    configManager.readOrCreateSettingJsonSync()
    ...
    MainWindow = new BrowserWindow({
        ...
        webPreferences: {
            ...
            webSecurity: true,
            preload: path.join(__dirname, "..", "renderer", "src", "preload", "preload_main.js"),
        }
    })
    ...
    MainWindow.on("close", function () {
        ...
        try {
            ...
            settings["token"] = "";
            configManager.writeSettingsSync(settings);
        } catch (error) {
