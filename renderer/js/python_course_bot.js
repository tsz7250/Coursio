...
class PythonCourseBot {
    constructor() {
        ...
        this.botScriptPath = path.join(__dirname, '../../py/yzuCourseBot.py');
        this.modelPath = path.join(__dirname, '../../py/model.h5');
        this.requirementsPath = path.join(__dirname, '../../py/requirements.txt');
        this.accountsPath = path.join(__dirname, '../../py/accounts.ini');
...
Password=${password}`;
    ...
    async startCourseSelection(options = {}) {
        ...
        try {
            ...
            // 啟動 Python 程序
            this.currentProcess = spawn(this.pythonPath, [this.botScriptPath], {
