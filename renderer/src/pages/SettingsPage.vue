<template>
  <div ss-container id="section-Settings" class="inner-section is-shown">
    ...
    <div class="scroll-content scroll-content-tight">
      ...
      <div class="settings-card">
        ...
        <div class="setting-row">
          ...
          <div class="setting-row-control">
            <span class="setting-value-text">{{ Store.sid || '未登入' }}</span>
          </div>
        </div>
        <div class="setting-row">
          <div class="setting-label">
      ...
      <div class="settings-card">
        <h4 class="settings-card-title">
          <i data-lucide="key" class="icon-18"></i>
          記住帳密設定
        </h4>
        <div class="setting-row">
          <div class="setting-label">
        ...
        <div class="setting-row">
          ...
          <div class="setting-row-control u-flex-col-end">
            <div class="u-flex-center-gap6">
              <input v-model="configPath" class="form-control u-input-path"
              ...
              <button class="btn btn-outline btn-sm" @click="browseConfigPath" title="瀏覽檔案">
                <i data-lucide="folder-open" class="icon-13"></i>
              </button>
            </div>
            <button class="btn btn-outline btn-sm" @click="saveConfigPath">
              <i data-lucide="save" class="icon-13"></i> 儲存路徑
            </button>
          </div>
        </div>
      </div>
...
// (logout 現由 useLogout 提供，已包含 spwd 清除)
